...
public class MissingInteger {
    public int firstMissingPositive(ArrayList<Integer> a) {
        ...
        for (int i = 0; i < length;) {
            int v = a.get(i);
            if(v - 1 != i && v>=1 && v<=length && v != a.get(v - 1)) {
                swap(a, i, v - 1);
            } else {
                i++;
            }
    ...
    private void swap(final ArrayList<Integer> a, final int i, final int j) {
        int tmp = a.get(i);
        a.set(i, a.get(j));
        a.set(j, tmp);
    }
    ...
    public static void main(String[] args) {
        ...
        final ArrayList<Integer> list = new ArrayList<Integer>(Arrays.<Integer>asList(1));
        ...
        final int i = integer.firstMissingPositive(list);
        Collections.sort(list);
        System.out.println(list);
        System.out.println(i);

        for(int ii = 1; ii < 50; ii++)
        System.out.println(ii + ":" + integer.isPrime(ii));
    }
